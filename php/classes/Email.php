...
class Email {
    function sendEmail($email,$lastname,$username,$password,$subject){
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table align="" style="padding: 20px">
                                            <tr>
                                                <td align="right"><h3 class="collapse" style="font-weight: bolder">TB-NODE DATA MANAGEMENT SYSTEM</h3></td>
                                            </tr>
                                        </table>
                                        <!-- /column 1 -->
                            ...
                            <div class="content">
                                <table>
                                    <tr>
                                        <td>
                                            <h3>Dear '.$lastname.'</h3>
                                            <p class="lead">Your new Account on TB-NODE Data Management System (TB-NODE DMS) have been created by your supervisor.</p>
                                            <p class="lead">Username: '.$username.'</p>
                                            <p class="lead">Password: '.$password.'</p>
                                            <!-- Callout Panel -->
                                            <p class="callout">
                                                Your advice to login and change your password as soon as possible <a href="https://tbnode.exit-tb.org/">&nbsp;Login Now &raquo;</a>
                                            </p><!-- /Callout Panel -->
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <table align="left" class="column">
                                                            <tr>
                                                                <td>
                                                                    <p style="font-weight: bolder">Visit our website at : <a href="https://tbnode.exit-tb.org/">www.tbnode.exit-tb.org</a></p>
                                                                    <p> </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table align="left" class="column">
                                                            <tr>
                                                                <td>
                                                                    <p style="font-weight: bolder">Send us an Email : <strong><a href="tb-node@exit-tb.org">tb-node@exit-tb.org</a></strong></p>
                                                                </td>
                                                            </tr>
                                                        </table><!-- /column 2 -->
                                                    </td>
        ...
        $mail->isSMTP();
        $mail->SMTPAuth = true;
        $mail->Username = "tb-node@exit-tb.org";
        $mail->Password = "Server@admin1";
        $mail->SMTPSecure = "tls"; //TLS
        $mail->Port = 587; //587
        $mail->addAddress($email);
        $mail->setFrom('tb-node@exit-tb.org','TB-NODE Data Management System');
        $mail->addReplyTo('tb-node@exit-tb.org');
                            ...
                            <div class="content">
                                <table>
                                    <tr>
                                        <td>
                                            <h3>Dear '.$all.'</h3>
                                            <p class="lead">In our best efforts to provide an excellent service to all users of TB-NODE DMS, we are scheduling performing system update tommorow 21th of June at 1600hrs and expected to be completed at 23th of June at 2300hrs. During the update, some of functionality may not be available or not working properly.</p>
                            ...
                            <div class="content">
                                <table>
                                    <tr>
                                        <td>
                                            <h3>Dear '.$all.'</h3>
                                            <p class="lead">In our best efforts to provide an excellent service to all users of TB-NODE DMS, we have currently finished upgrade the system and its is now back online.</p>
                                            ...
                                            Due to these security upgrade your required to RESET YOUR PASSWORD so that you can access your account again.<br><a href="https://tbnode.exit-tb.org/reset.php?token='.$token.'" style="color: #1c94c4"> CLICK HERE TO RESET </a> </p>
